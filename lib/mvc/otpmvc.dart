...
class otpmvc extends StatefulWidget{
  TextEditingController email=new TextEditingController();
  var txt='';
  otpmvc({required this.email,required this.txt});
  @override
  State<StatefulWidget> createState() {
    return _otpmvcstate(email: this.email,txt: this.txt);
  }
}
class _otpmvcstate extends State<otpmvc>{
  ...
  TextEditingController email=new TextEditingController();
  _otpmvcstate({required this.email,required this.txt});
